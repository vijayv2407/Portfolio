  ...
  return (
    <div>
      <div className="laptop">
        <section className="contact mb-4 pb-5">
          ...
          <div className="container">
            <div className="d-flex justify-content-between skill">
              <div className="myskills col-lg-12">
                <div className="headingforcontact text-center " ata-aos="fade-right">
                ...
                <div>
                  ...
                  <div className="contact row mx-auto px-5">
                    <div className="col-lg-6 col" ata-aos="fade-up">
                      <h2>My Address</h2>
                      <div className="py-3">
          ...
          <div className="container">
            <div className="skill">
              <div className="myskills">
                <div className="headingforcontact text-center " data-aos="fade-right">
                  <span className="text-muted">CONTACT</span>
                  <h2>Contact Me</h2>
                </div>
                <div className="">
                  ...
                  <div className="contact">
                    <div className="text-start mx-5">
                      ...
                      <div className="col py-3">
                        <div className="maindivforaddress1 d-flex gap-4" data-aos="fade-left">
                          <div className="subdivforaddress1">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="16"
